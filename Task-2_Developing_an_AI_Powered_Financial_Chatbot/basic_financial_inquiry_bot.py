...
final_report = pd.read_csv("/home/baris/Desktop/bcgxgenai/Task-1_Data_Extraction_and_Initial_Analysis/final_data_report.csv")
summary_report = pd.read_csv("/home/baris/Desktop/bcgxgenai/Task-1_Data_Extraction_and_Initial_Analysis/Summary_Final_Report.csv")

#Creating a basic rule-driven financial inquiry chatbot.
def financial_chatbot():
    print("\n Please enter your query: ")
    user_query = input()
    if user_query == "What is total revenue?":
        revenue = final_report[(final_report['Year'] == fiscal_year) & (final_report['Company'] == company_input)][
...
while True:
    ...
    if user_input.lower() == "exit":
        ...
        print("\nHello! Welcome to Financial Chatbot!!!")
